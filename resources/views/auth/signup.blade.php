        ...
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <form method="POST" action="{{ route('register') }}" class="sign-up-form">
                    ...
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input type="text" placeholder="User Name" class="@error('user_name') is-invalid @enderror"
                    ...
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="password" placeholder="Confirm Password" class="@error('password') is-invalid @enderror"
        ...
        <div class="panels-container">
            ...
            <div class="panel right-panel">
                <div class="content">
                    ...
                    <button class="btn transparent" onclick="login()" id="sign-in-btn">
                        Sign in
                    </button>
                </div>
            </div>
